...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO `tbl_book` (`tbl_book_id`, `book_isbn`, `book_title`, `book_author`, `book_publisher`, `book_section`) VALUES (NULL, :bookISBN, :bookTitle, :bookAuthor, :bookPublisher, :bookSection)");
